...
The program includes the Maven Wrapper mvnw. By running the command:   mvnw clean package
A .jar file will be generated in the target folder.
Then you can start the application by executing the command:   java -jar name_of_the_jar_file.jar
